...
int main() {
  ...
  while (getline(&line, &linecap, fp) != -1) {
    ...
    if ((opp == 'A') && (self == 'X')) score = LOSE + SCISSORS;
    else if ((opp == 'A') && (self == 'Y')) score = DRAW + ROCK;
    else if ((opp == 'A') && (self == 'Z')) score = WIN + PAPER;
    else if ((opp == 'B') && (self == 'X')) score = LOSE + ROCK;
    else if ((opp == 'B') && (self == 'Y')) score = DRAW + PAPER;
    else if ((opp == 'B') && (self == 'Z')) score = WIN + SCISSORS;
    else if ((opp == 'C') && (self == 'X')) score = LOSE + PAPER;
    else if ((opp == 'C') && (self == 'Y')) score = DRAW + SCISSORS;
    else if ((opp == 'C') && (self == 'Z')) score = WIN + ROCK;
